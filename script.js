...
const animateOnScroll = () => {
    const elements = document.querySelectorAll('.hackathon-card, .info-card, .feature-item, .floating-card');
...
document.querySelectorAll('.hackathon-card, .info-card, .feature-item, .floating-card').forEach(element => {
